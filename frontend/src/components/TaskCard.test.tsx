...
describe('TaskCard', () => {
  ...
  it('renders task description when provided', () => {
    ...
    expect(screen.getByText(mockItems.withDescription.description)).toBeInTheDocument()
  })
  ...
  it('renders delete button', () => {
    render(<TaskCard {...defaultProps} />)
    expect(screen.getByTestId(`delete-task-${mockItems.simple.id}`)).toBeInTheDocument()
  })
  ...
  it('calls onDelete when delete button is clicked', async () => {
    ...
    const deleteButton = screen.getByTestId(`delete-task-${mockItems.simple.id}`)
