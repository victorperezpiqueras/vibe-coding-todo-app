...
Commands for installation, format, linting, testing, and running the application are defined in the [Makefile](../Makefile).
Use them from the project root directory.
